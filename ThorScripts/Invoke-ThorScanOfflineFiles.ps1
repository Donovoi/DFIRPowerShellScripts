...
if ($Thor -eq $null)
{
	Write-Host "Error: thor64.exe not found in the current directory or its subdirectories"
	exit 1
}
else
{
	Write-Host "Located thor64.exe at $Thor"
}
...
{
	Write-Host "Creating $outputPathThor"
	New-Item -ItemType Directory -Path $outputPathThor -Force | Out-Null
}
else
{
	Write-Host "$outputPathThor already exists"
}
...
Write-Host "Executing $Thor with the following arguments: $args"
Write-Host "Please check the Thor config file located at: $thorConfigYamlFilename"
Write-Host "This is important because the max_file_size value is likely set for 5GB, so if you need larger than that, please modify the value prior to scanning"

# SIG # Begin signature block
# MIIvngYJKoZIhvcNAQcCoIIvjzCCL4sCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAqIHh+Z0eJcdb3
# tsyUHLYFtLjaBA1+OZBRDu2E7diCBaCCKKMwggQyMIIDGqADAgECAgEBMA0GCSqG
...
# wZgMsmXXNfY3p3CN76gg7cxaZyFbo+Cxqp31ld03FTANBgkqhkiG9w0BAQEFAASC
# AgCMbIVm+9PkGL0cByokfyDSqD4KqdAsPQnzdtDvPYiPnpqoVdSYS353PbocgfO6
# cQz3/yJLz3spIyCqZpruROkBLXiB8f6jSgJ577i8Z+alH8uzh9GnSePm3fo7vl6f
# +WePgusV90ZaxX7Iw95sSdzY50LSuj3CNQNwaPZAfLt+PZksR3jerBpK+rjlxw79
# LH9lLvSIxcAKt68tY220ALda4nB8mKHDABnKplqXM2hfMOxW+hJgqG8ECzUpR4o2
# gvt9biambSL1lCIK4AVylAbiMcCknNmpX26dZWDAR+Dmy5YT6mukvuxIayVkziqY
# oszSEb9WQPBRN1jdNo8asKc3DtohQgQJXsvABhDXpreT/qLU0Z1Q0A1TkfKMqUq7
# WQ74VRgzutJSFTlMcSoy2B836oQ3yB8zZGjbI9fvCKBAjDG5Hy79OwbF1g0vc+GS
# rADVO4HS01vHN8x8YVUjSIawJCGfInXSRLe3PU9uXdtLt8a+IcRLqC/s99nOsihu
# V1tIM6C1DrGoSurwPBVIWquGjM5WVxX4fpQbkGhK9Qbfmj3w6eY+fPR6qXA2guPg
# mF+FsCr5BLMwCEeG/7EHzfjPaRMgGC05o6OmlVCETCvqKfinFUHWYSP9Ti2DZX3H
# Sm3tPoaQz13WO36DjWDSI8+RfwI7z29vjYYkIKbANKFOIaGCA2wwggNoBgkqhkiG
...
# OTA0MTYwNDU3WjArBgkqhkiG9w0BCTQxHjAcMAsGCWCGSAFlAwQCAaENBgkqhkiG
# 9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgRrtf+X9IqNHk07lcsunHpR7ZQPCL532x
# m2wvox9QbMYwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGOMIGLBBRE05OczRuIf4Z6
...
# AYBlSK9rNhv7EvpwA6JLXMwBboI2ZvsS1x1XR2l3wO2HzRMmD65fhA5sOILjzCSa
# I896qzxg1cXzgz6P2vDB8CuF+xQXRYkgy1aAPeA6NtDAfVfWbBF7kht+X+nDj43L
# gaSGBAq/Gq8dONFF1iO999npKxwzmz0LkG3BAZGHXAu/lsv4sMIEWiFukMv/yKZv
# HY18WRCyocaSNyNTB0ci1BxBydN7T7o9HezcMf0MJARiIdlYAEySnexB06CFq8Rd
# W0BqMoXm7IN7vHd3oGlsl7PckDbuYLjsTNJ1ogJKfU41CdZAaI7+RLjwwGbI+Xym
# wwyKa4yL/A2qKJGYavKyRreyVJIyAaL/9HTUvW0lXnYvBR0vE1tZNfqHosLpCMsz
# wDRVU4fPjbj9rlIEUAf9my/EzrBYAYXzIV26eXyP1yBX91eLbd7nDFDcdLQ8Y5EW
# 2NbamvifH6XM/uZeO+XV+TbL6xmoYGBpRjf8z8Q8CFQaF2F5DmAAtIcUA3/aYZtg
# dVI=
