...
$thorUtilText = 'thor-util.exe'

$ThorUtil = Get-ChildItem -Recurse -Path $PSScriptRoot -Include $thorUtilText

if ($ThorUtil -eq $null)
{
	Write-Host "Error: $thorUtilText not found in the current directory or its subdirectories"
	exit 1
}
else
{
	Write-Host "Located $thorUtilText at $ThorUtil"
}

Start-Process -FilePath $ThorUtil -ArgumentList "upgrade"
Write-Host "Upgrading $ThorUtil"

# SIG # Begin signature block
# MIIvngYJKoZIhvcNAQcCoIIvjzCCL4sCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCANTvYK48A22ANs
...
# AgAW0MHayTVNJVoo3fX3Ci9irZxuJa1YRTyIoUzAouA4BFg9h7ut5/zIjMcm9QG4
# h4/rmEfmZrgiCYhmP503Ml8w6mGopPJ47VyXdNDNLUDmRqHRAMenHZXxlYqfyaj4
# rFGZZkVdlIg049jUoysuhRVbtGrwd3lE5c0OXrkrlOqpTbOHZQ8U/TcJ4qRItl2c
# 8a3i/T2HVuTB4tWpOomJr3me9rwOCnVgkuXjak44jfaXLgzUMD+2FXimcAj6O9Jg
# RU08qkEiSvadPv2u5gw6NJSZavwfZahluNjS10YHhusYk4fzkYP49HU2P7Wp6GfC
# lGa/Ot7bnQ9uUbdfdlRfo4mm6qE3gMjCc2A33GmnGFtoSGqpFF7PlsIwCLNP84Vu
# 7Dsi/UyT/SQSplUYJh+TkWpWtH+HSwbgIr4DUr6+QjrdcpLjjQwqFMTO20AkKC7D
# ICkXA35br+oGO7yxN+d12pIfd5Zus08/03yzFPpV/8qBa0+Ia5e8CUC97kLRQlmH
# RpEZ5loZRHvB49XL7irUY5UpeHaFaFwjNBWBRQt9VvfQciDMKC7CZMD1n+/TYeW4
# oo+Hr6S+X4efRVzF06IOqBkPqL/f8doH1sUqavbwXZ/w5AnYqMgBLmzfcBWyKKzT
...
# OTA0MTU1ODE4WjArBgkqhkiG9w0BCTQxHjAcMAsGCWCGSAFlAwQCAaENBgkqhkiG
...
# AYBw5/o9QKa4TdOCu2mc2Otb/iDNeXvd+1+C/FVLwGgJnRpVwhJ3Ksnf0dx4RgYE
# +QTdMwyyHFFVRq5Gll33ejB+KsrzZYotb01x96hFcOjUOqZ9vdPB+7qxyA3EbpON
# u682Uw/yTyiEAIx7R3PnYpVYkV3EbVOCpLot3B0fg1L3C5NztYAbGp44uTx0/Zdm
# 6VuJw4cDEqL9/rcMCg7tg+1ToRZ5fDEugH8bKK/xmOXZAr7C6ChVlB5GARJYVq4Q
# 0erE1AKp2aVOuqEzQgZiOCaZ2smCGixOj5rRqmYuCHin+WqLN15qfHETnefiHqm8
# SucnA34D4dkFVrb8pj2z+cnpvlXg0qIMKLEzGibMt39cgkLwBaAOaKlFuz9iarG5
# aLw+Bw7Hlt6ugvGNBy+4xIlPXothw+NEMKCLrZTYQc5uXUYXqkCzEUFF+4aRKzXI
# El/ihRkvh1x9je60z2JJmcJeS8cmkALcfFVazEh60V7/AJAFFGD1GFrkmAzcyIYn
# kZY=
